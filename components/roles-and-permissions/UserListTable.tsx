...
import { EllipsisOutlined, RightOutlined, LeftOutlined, UserOutlined } from '@ant-design/icons'
import TableSortArrow from '../common/TableSortArrow'
import dayjs from 'dayjs'
import { usePopperTooltip } from 'react-popper-tooltip';
import 'react-popper-tooltip/dist/styles.css';
import NameWithPopover from './NameWithPopover'
            ...
            <table {...getTableProps()} className="w-full">
                ...
                <tbody {...getTableBodyProps()}>
                    {page.map(row => {
                        ...
                        return (
                            <tr {...row.getRowProps()} className="cursor-default">
                                {row.cells.map(cell => {
                                    return (
                                        <td {...cell.getCellProps()}  className={`${cell.column.colClassName} cursor-default py-4 px-4 text-xs text-left border-b`} >
                                            {cell.render('Cell')}
